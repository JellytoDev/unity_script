...
public class ListPurchaseBtn : MonoBehaviour
{
    ...
    public void purchaseButton()
    {
        ...
        //firebase에서 모든 항목 물품 가져오기

        string clothName = "cloth" + btn.tag.ToString();
        string shopName = "meta_shop";//GameData.shopName;

        ClothDataGet("wjdwhdgus222@naver.com", "basket", shopName, clothName);

        DialogChange("장바구니 성공", "선택하신 상품이 장바구니에 넣어졌습니다. \n해당 상품은 드레스룸에서 입어본 모습을 확인할 수 있습니다.");
